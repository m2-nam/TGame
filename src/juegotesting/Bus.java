...
public class Bus extends javax.swing.JFrame {
    ...
    public Bus() {
        initComponents();
        ImageIcon  pic1 = new ImageIcon(getClass().getResource("/pix/miss_bus.jpg"));
